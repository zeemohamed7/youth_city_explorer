...
import { Search, Filter, Clock, Calendar, Users, Upload, ChevronDown, BookmarkPlus, BookmarkCheck, CalendarDays, AlertTriangle, ArrowLeft } from 'lucide-react';
...
const MOCK_SCRAPED_DATA = [
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the world of satellites through an interactive simulation using the Tinkercad platform, where they experience the experience of rescuing a satellite by working in teams, and learning about orbit, energy and communication systems."
  },
  {
    "id": 5,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the world of astronauts through an interactive experience that simulates aspects of their real training, through tests, motor and mental challenges, and fun space missions that develop their various skills and abilities."
  },
  {
    "id": 7,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of space exploration and space missions using Minecraft Space Exploration, through an interactive environment based on building, teamwork, and space challenges."
  },
  {
    "id": 8,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of astronomy and sky observation skills, through an interactive experience that helps them learn about celestial bodies and acquire the basic tools to begin their journey in stargazing with confidence and enjoyment."
  },
  {
    "id": 11,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the concepts of sustainability and environmental preservation through interactive activities and creative challenges that reinforce positive behaviors and encourage them to make a positive impact in their communities."
  },
  {
    "id": 12,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to enable participants to design interactive projects that combine physical computing and electronics, employ programming to solve real-life problems and develop prototypes that contribute to addressing challenges related to the sustainable development goals."
  },
  {
    "id": 13,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the world of robotics and engineering through a practical experience that allows them to design, build and program real robots using specialized tools, through fun challenges and projects that develop innovation and problem-solving skills."
  },
  {
    "id": 14,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of artificial intelligence and Python programming through an interactive training bootcamp, which allows them to build simple artificial intelligence models, use generative artificial intelligence tools, in addition to developing innovative digital projects that conclude with a competitive hackathon in which they present their outputs."
  },
  {
    "id": 15,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of agriculture and the importance of preserving the environment and natural resources, through enjoyable practical activities that enhance their connection with nature and develop their love of agriculture."
  },
  {
    "id": 16,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of 3D printing and digital manufacturing, by integrating design thinking, practical manufacturing and product development within a technological innovation environment, to enable them to keep pace with modern technologies."
  },
  {
    "id": 20,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to empower emerging generations and youth with basic life-saving skills, by integrating realistic simulation with modern technologies, to transform theoretical knowledge into immediate response in emergency situations and to enhance societal responsibility and leadership during crises."
  },
  {
    "id": 21,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of programming through an interactive experience based on game design, animation, and simple applications, enabling them to think like programmers and create their own digital projects."
  },
  {
    "id": 24,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to integrate participants into the fields of engineering and technology through three main axes, including: building engineering and sustainable environment, engineering of green materials and solutions, and future energy and smart control, through practical activities and realistic simulations covering the installation of electrical circuits and the design of environmentally friendly solutions."
  },
  {
    "id": 25,
    "center": "Science & Technology",
  ...
  },
  {
    "id": 26,
    "center": "Science & Technology",
    "title": "Intelligence Explorers: The journey of future children in the world of artificial intelligence",
    "org": "",
    "age": "12 to 14 years",
    "ageMin": 12,
    "ageMax": 14,
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of artificial intelligence through educational games and fun, realistic experiences using visual tools such as Scratch and the Teachable Machine, with the aim of developing their logical thinking skills and creativity at an early age."
  },
  {
    "id": 27,
    "center": "Science & Technology",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the indigenous and endemic fruit trees in the Bahraini environment, and to strengthen their connection to the local agricultural identity by learning about their importance and ways to propagate and preserve them."
  },
  {
    "id": 28,
    "center": "Science & Technology",
    ...
    "description": "The program aims to introduce participants to the basics of cybersecurity through extensive practical training that includes applied laboratories and challenge-based exercises, allowing them to acquire technical skills and experiences that simulate real-world work environments."
  },
  {
    "id": 29,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "timeCategory": "Afternoon",
    "description": "The program aims to emulate the experience of space startups by enabling participants to design an innovative satellite to solve a real problem, from generating the idea to presenting the project to a jury in a professional manner."
  },
  {
    "id": 31,
    "center": "Science & Technology",
    ...
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the concept of Earth observation and its role in extracting geospatial information that supports national decision-making, through learning about remote sensing techniques, satellite images, geographic information systems, and data analysis."
  },
  {
    "id": 32,
    "center": "Science & Technology",
    ...
    "description": "The program aims to immerse participants in an interactive studio environment that simulates the life cycle of professional game development, where they collaborate to complete a 3D game project and publish it on a global platform, transforming them from mere players into publishing developers."
  },
  {
    "id": 33,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "time": "4:00 PM to 7:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to develop the capabilities of participants in the field of cybersecurity through interactive training workshops that combine theoretical knowledge and practical application, which contributes to enhancing digital awareness, understanding cyber threats, and acquiring basic skills to protect systems and data."
  },
  {
    "id": 38,
    "center": "Science & Technology",
    ...
    "timeCategory": "Evening",
    "description": "The workshop aims to introduce participants to career paths in the field of cybersecurity through interactive content and guidance sessions that highlight the different specializations, required skills, professional certificates, and educational paths, helping participants explore professional opportunities appropriate to their interests and abilities."
  },
  {
    "id": 39,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "timeCategory": "Evening",
    "description": "The program aims to introduce participants to the concept of radiation, its types, sources and uses through interactive methods that combine simplified explanation and applied activities, while highlighting the principles of safety and radiation protection and linking scientific concepts to daily life situations."
  },
  {
    "id": 42,
    "center": "Science & Technology",
    ...
    "time": "4:00 PM to 6:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to empower participants by raising their awareness of emergency situations, promoting digital health culture, and combating misleading information, in addition to developing their leadership skills and sense of social responsibility in an interactive manner."
  },
  {
    "id": 43,
    "center": "Science & Technology",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enable participants to design and build their own board and physical games, by integrating game design thinking with basic electronics and digital manufacturing tools such as vinyl cutting, to transform their ideas into playable interactive models and test them with others."
  },
  {
    "id": 44,
    "center": "Science & Technology",
    ...
    "timeCategory": "Evening",
    "description": "The program aims to introduce participants to the basics of architecture through a series of theoretical and practical workshops, to enable them to explore their technical and engineering skills and understand architecture more deeply, in cooperation with the Royal University for Girls."
  },
  {
    "id": 45,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "time": "4:00 PM to 7:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics and features of generative artificial intelligence and large language models (LLMs), with an emphasis on advanced command engineering techniques. Participants discover how to effectively work with tools such as ChatGPT, Gemini, and Claude to increase productivity, and build intelligent assistants customized to serve their academic and professional goals."
  },
  {
    "id": 52,
    "center": "Science & Technology",
    ...
    "time": "4:00 PM to 7:00 PM",
    "timeCategory": "Afternoon",
    "description": "The workshop aims to introduce participants to the various professional opportunities in the environmental sector, by reviewing the academic paths, skills and experiences necessary to work in the environmental fields, which will help them explore their interests and develop a vision for their professional future in this sector."
  },
  {
    "id": 53,
    "center": "Science & Technology",
    ...
    "time": "4:00 PM to 7:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the world of bees and their importance in environmental balance through an interactive experience that reviews the life cycle of bees, their roles within the hive, and their relationship with plants and biodiversity, in addition to learning about local experiences in beekeeping, which enhances their understanding of the role of bees in pollination, food production, and the sustainability of ecosystems."
  },
  {
    "id": 54,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "timeCategory": "Afternoon",
    "description": "The program aims to empower young participants and emerging generations with basic life-saving skills, by integrating realistic simulation with modern technologies, to transform theoretical knowledge into immediate and effective response in emergency situations."
  },
  {
    "id": 57,
    "center": "Science & Technology",
    ...
    "time": "6:30 PM to 8:30 PM",
    "timeCategory": "Evening",
    "description": "The program aims to enable participants to develop a smart model to simulate an agricultural reserve on the International Space Station, using artificial intelligence and data analysis to control the growth of plants and continuously monitor their condition."
  },
  {
    "id": 58,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to provide an applied experience in entrepreneurship in which participants live the journey of establishing a start-up company that uses space technologies to solve realistic challenges and turn them into profitable opportunities, which enhances innovative thinking and decision-making ability."
  },
  {
    "id": 61,
    "center": "Science & Technology",
    ...
    "time": "4:00 PM to 7:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enable participants to acquire scientific research skills using artificial intelligence tools at various stages of the research process, starting from idea generation and data analysis to academic writing and scientific publishing. It also contributes to developing critical thinking and innovation skills, which enhances the participants’ ability to produce high-quality scientific research."
  },
  {
    "id": 62,
    "center": "Science & Technology",
    ...
    "time": "4:00 PM to 7:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enhance participants’ awareness of the importance of intellectual property and protecting innovations, through awareness workshops and specialized advisory sessions that provide practical guidance on mechanisms for protecting ideas and registering intellectual rights, thus supporting participants in transforming their innovations into sustainable legal assets."
  },
  {
    "id": 63,
    "center": "Science & Technology",
    "title": "How do we design friendly environments for people with disabilities?",
    "org": "",
    "age": "18 to 35 years",
    "ageMin": 18,
    "ageMax": 35,
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to simplify the concepts of genomics and genetics for participants and link them to scientific research, health and daily life, while empowering and training them to consciously transfer this knowledge to others to be “genomic ambassadors” in society."
  },
  {
    "id": 66,
    "center": "Science & Technology",
  ...
  },
  {
    ...
    "timeCategory": "Evening",
    "description": "The “Bahraini” program is a national educational program that aims to consolidate the Bahraini identity through interaction with the Bahraini dialect, customs, traditions, and popular heritage in a modern and interactive educational manner."
  },
  {
    "id": 70,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the Bahraini identity by exploring customs and traditions, folk arts, and Freej life, through creative activities and interactive experiences that enhance belonging, pride in the homeland, and preservation of cultural heritage."
  },
  {
    "id": 72,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The workshop aims to introduce participants to the concepts of money, banks, payment systems, and the role of the central bank through simplified interactive activities. Participants also learn about the basics of money management, saving and spending, in addition to exploring modern financial technologies such as digital payments and payment wallets."
  },
  {
    "id": 73,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "An interactive program for children, inspired by the book “Dana of Diplomacy,” and takes participants on an interesting journey to learn about the world of diplomacy, and the role of the Ministry of Foreign Affairs and embassies in building relations between countries and promoting peace and cooperation among peoples."
  },
  {
    "id": 74,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of creative thinking and entrepreneurship through interactive activities and practical challenges, which help them generate ideas, transform them into simple projects, and develop the spirit of initiative, teamwork, and self-confidence."
  },
  {
    "id": 75,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of financial culture through interactive activities and practical experiences, which help them understand the value of money, manage expenses, and make responsible financial decisions in a manner appropriate to their ages."
  },
  {
    "id": 77,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the authentic Bahraini heritage through an interactive experience that combines land and sea skills, cultural etiquette, customs and traditions, which contributes to strengthening their connection to the national identity and consolidating the social values ​​derived from Bahraini heritage."
  },
  {
    "id": 79,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The lecture aims to enhance participants’ awareness of the dangers of electronic games and their behavioral and legal effects, and to familiarize them with their rights and duties while using games and digital platforms. It also highlights the foundations of safe and responsible use of electronic games and the importance of protecting privacy and personal data in the digital environment."
  },
  {
    "id": 80,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The lecture aims to introduce participants to the concept of electronic fraud and its most prominent methods and common forms in the digital environment, and to develop critical thinking skills when dealing with messages, links, and electronic content. It also highlights the importance of verifying sources, adopting safe digital practices, and reporting fraud attempts, which contributes to enhancing awareness and protecting the digital community."
  },
  {
    "id": 81,
    "center": "Leadership & Entrepreneurship",
    "title": "Electronic blackmail: If someone threatens me online, what should I do?",
    "org": "Institute of Judicial and Legal Studies",
    "age": "9 to 11 years",
    "ageMin": 9,
    "ageMax": 11,
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of volunteer work and organizing events, through a practical experience that allows them to plan and implement community initiatives, in a way that enhances the spirit of responsibility, teamwork, and belonging to the homeland."
  },
  {
    "id": 83,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the concept of emotional intelligence and its importance in daily life, through interactive activities that help them understand their feelings, communicate positively with others, and manage different situations with confidence and awareness."
  },
  {
    "id": 84,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to leadership and life skills, and to enhance the values ​​of gratitude and giving, through practical activities and interactive experiences that help them build character, serve society, and make a positive impact."
  },
  {
    "id": 85,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of public speaking and leadership, through interactive activities and practical applications that help them organize ideas, speak confidently, and develop verbal and non-verbal communication skills."
  },
  {
    "id": 87,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of dialogue and the art of debate, and to develop critical thinking and the ability to build logical arguments and express opinions with confidence, through practical activities and interactive debates that enhance respect for different points of view."
  },
  {
    "id": 88,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop participants' leadership skills through interactive workshops and parliamentary simulation experiences, enabling them to formulate and discuss ideas and submit constructive proposals that serve society and the nation."
  },
  {
    "id": 89,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to basic life skills and prepare for the future, through interactive activities that help them understand the requirements of the labor market, make personal and financial decisions, and enhance self-reliance."
  },
  {
    "id": 90,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the principles of leadership and excellence, through practical challenges and interactive workshops that develop the spirit of initiative, teamwork, and problem solving, and enable them to transform their ideas into distinguished achievements."
  },
  {
    "id": 91,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to enable participants to transform ideas into practical solutions through a set of interactive applications and exercises that develop creative thinking, enhance teamwork skills, and solve challenges."
  },
  {
    "id": 92,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The lecture aims to enhance participants' awareness of the basics of safe online shopping, and introduce them to the best practices to protect their data and rights while purchasing online. It also highlights fraudulent methods associated with fake stores and misleading offers, and explains mechanisms for verifying the credibility of websites before completing purchases."
  },
  {
    "id": 94,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to instill the values ​​of sophisticated behavior and public taste among the participants, by providing them with the principles and arts of social and daily etiquette within the framework of a training experience that combines knowledge and practical application."
  },
  {
    "id": 95,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "4:00 PM to 6:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the world of finance and real life through an interactive experience that allows them to make real decisions about their professional future, their studies, and their financial situation in a model that simulates reality."
  },
  {
    "id": 98,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to blockchain technology and digital assets, including cryptocurrencies and tokenized stocks, through a practical training experience that reviews the mechanisms of their use, management and analysis, and their role in shaping the future of the digital economy."
  },
  {
    "id": 100,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to entrepreneurship skills through an applied experience for establishing and managing companies, in a way that develops their leadership skills, decision-making, teamwork, and financial awareness."
  },
  {
    "id": 101,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enhance the spirit of cooperation and social responsibility among participants through an interactive simulation of the challenges of daily life, to train them to devise consensus solutions and launch projects with a positive impact."
  },
  {
    "id": 102,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enhance participants' negotiation and collective decision-making skills through an interactive simulation experience that requires reaching consensuses that serve diverse needs and priorities."
  },
  {
    "id": 103,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 6:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the dimensions of the dynamic world of marketing through interactive challenges and innovative group activities, enabling them to go through the full experience of building a commercial identity, designing promotional campaigns, and mastering presentation and selling skills."
  },
  {
    "id": 104,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "6:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The workshop aims to enhance the critical thinking and dialogue skills of the participants through an interactive simulation of realistic administrative challenges, allowing them to express their convictions and positions in a dynamic manner that consolidates the ability to express opinions and understand the points of view of others."
  },
  {
    "id": 108,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "6:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The workshop aims to provide participants with the basic concepts of emotional intelligence, train them on self-management skills and control emotions at various age levels, and provide them with the necessary tools to deal professionally with different personality types and understand their needs."
  },
  {
    "id": 110,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The workshop aims to hone the teamwork skills of the participants by applying the “Tuckman Model” in an interactive environment, to enable them to understand the stages of teams’ development, develop communication tools, and manage tasks and decisions efficiently under work pressure."
  },
  {
    "id": 112,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 6:00 PM",
    "timeCategory": "Afternoon",
    "description": "The workshop aims to enable participants to understand the regulatory requirements and requirements associated with practicing commercial activities, through an interactive workshop based on applied activities and realistic simulations, which helps them establish their projects on sound and sustainable foundations."
  },
  {
    "id": 113,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "6:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The workshop aims to introduce participants to marketing skills and strategies by understanding data, analyzing it, and using it to make decisions. It also provides them with practical experience that simulates business environments and helps them understand the mechanisms of growth and development."
  },
  {
    "id": 114,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "6:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to break the social stigma associated with mental health, and establish the concept that talking about it and seeking support is normal, safe, and an integral part of life, while enabling young people to transform this awareness into societal impact."
  },
  {
    "id": 117,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to empower participants with entrepreneurship skills, by directing them towards formulating their ideas and turning them into successful and sustainable startup projects."
  },
  {
    "id": 119,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to hone participants’ leadership and personal skills and employ artificial intelligence techniques within the framework of an interactive educational experience, to qualify youth competencies capable of keeping pace with the requirements of the smart labor market and confronting contemporary economic and technical developments."
  },
  {
    "id": 120,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to qualify participants to move confidently into the labor market by developing the skills of preparing a professional CV and preparing for personal interviews, while benefiting from the expertise of human resources specialists to understand employment requirements and enhance their professional readiness."
  },
  {
    "id": 123,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enable participants to develop local products and services capable of competing in regional and global markets, by providing them with the necessary knowledge and skills in brand building, international marketing, and export requirements, through specialized workshops and field experiences that enhance their readiness for expansion in foreign markets."
  },
  {
    "id": 124,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "5:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to provide participants with the opportunity to benefit from the expertise of EY specialists through short interactive sessions that showcase problem-solving methods, structured thinking, and effective communication, thus enhancing their understanding of the consulting work environment."
  },
  {
    "id": 128,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "5:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to enable participants to benefit from one-on-one mentoring sessions with EY consultants in multiple fields, allowing them to ask questions and receive specialized career guidance that supports their academic and professional careers."
  },
  {
    "id": 129,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "5:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to develop participants’ skills in analyzing business problems by working on a realistic case study and applying the strategic thinking and analysis methodologies used at EY to reach practical and convincing solutions."
  },
  {
    "id": 130,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "6:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to enhance personal financial awareness among participants, by providing them with the right skills and mechanisms to manage their financial affairs and plan their economic future effectively."
  },
  {
    "id": 131,
    "center": "Leadership & Entrepreneurship",
  ...
  },
  {
    ...
    "time": "5:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to support participants in developing their entrepreneurial ideas and projects by learning about business models, analyzing feasibility, and benefiting from the direct guidance of EY experts, leading to building effective investment offers and presenting them to investors."
  },
  {
    "id": 133,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "5:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to prepare participants to enter the labor market by exploring different career paths, developing job interview skills, and building a professional and personal identity that enhances their career opportunities."
  },
  {
    "id": 134,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to provide an integrated experience starting from planning events and initiatives all the way to their implementation and evaluation, with a focus on organization skills, teamwork, resource management, and transforming ideas into realistic projects with impact that serve youth centers."
  },
  {
    "id": 135,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The workshop aims to empower participants with self-management skills and interpret human behavior according to the “Choice Theory” and the “Car” model, to explain how to control emotions by directing thoughts and actions instead of submitting to feelings and having complete control over reactions."
  },
  {
    "id": 136,
    "center": "Leadership & Entrepreneurship",
    ...
    "time": "5:00 PM to 8:00 PM",
    "timeCategory": "Evening",
    "description": "The program aims to prepare participants for the transition from university life to the work environment, by introducing them to the basic professional skills and behaviors that help them adapt and succeed in various work environments."
  },
  {
    "id": 137,
    "center": "Sports",
    ...
    "timeCategory": "Morning",
    "description": "The program aims to hone participants’ football talents by adopting quick and mini-competitive games, to develop basic technical skills and enhance tactical understanding of the game in an enjoyable training environment."
  },
  {
    "id": 138,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "10:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to hone the participants’ football talents by adopting quick and mini-competitive games, to develop basic technical skills and enhance tactical understanding of the game in an enjoyable training environment."
  },
  {
    "id": 154,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "9:00 AM to 10:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to hone participants' talents in 3X3 basketball through skills stations and competitive mini-games, to develop basic technical skills and enhance tactical understanding of the game."
  },
  {
    "id": 158,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "9:00 AM to 10:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to hone the talents of participants in 3X3 basketball through skills stations and mini-competitive games, to develop basic technical skills and enhance tactical understanding of the game."
  },
  {
    "id": 174,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "9:00 AM to 10:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop participants' basic skills in tennis through interactive exercises and games suitable for the age group, with a focus on the forehand, backhand, serve, reception, footwork, exchange of shots, and the basics of playing in matches."
  },
  {
    "id": 182,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "10:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop basic participation skills in tennis through interactive exercises and games suitable for the age group, with a focus on the forehand, backhand, serve, reception, footwork, exchange of strikes, and the basics of playing in matches."
  },
  {
    "id": 194,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "11:00 AM to 12:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop participants' basic skills in badminton through interactive exercises and fun competitive activities, with a focus on racket grip, serve, high kick, short shot, playing at the net, footwork, and control of exchanges."
  },
  {
    "id": 198,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "10:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop the basic skills of badminton through interactive exercises and fun competitive activities, with a focus on racket grip, serve, high shot, short shot, playing at the net, footwork, and control of exchanges."
  },
  {
    "id": 206,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "10:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop participants' basic table tennis skills through progressive drills and games that enhance accuracy, coordination and control, with an emphasis on racket grip, stance, serve, forehand, backhand, rotation awareness, and stability of exchanges."
  },
  {
    "id": 210,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "10:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop basic table tennis participation skills through progressive exercises and games that enhance accuracy, coordination and control, with an emphasis on racket grip, stance, serve, forehand, backhand, rotation awareness, and stability of exchanges."
  },
  {
    "id": 222,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "11:00 AM to 12:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop participants' basic cricket skills through indoor exercises using the net, focusing on grip, stance, batting fundamentals, throwing movement, catching, passing, and awareness of the game."
  },
  {
    "id": 226,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "9:00 AM to 10:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop basic cricketing skills through indoor exercises using the net, focusing on grip, stance, batting fundamentals, throwing movement, catching, passing, and awareness of the course of the game."
  },
  {
    "id": 234,
    "center": "Sports",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the world of theater through acting and performances, and to help them discover their talents and develop their artistic and expressive skills in a fun and age-appropriate manner."
  },
  {
    "id": 238,
    "center": "Media & Entertainment",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of journalistic and media work through interactive activities and practical applications, while developing the skills of news writing, interviewing, field coverage, and effective communication, leading to the production of a magazine that documents the most prominent news and events of Youth City 2030."
  },
  {
    "id": 239,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of content creation and social media in a way that is safe for children, with a focus on developing creativity, building self-confidence, and forming a conscious digital identity in a fun manner that suits their ages, from idea to publication."
  },
  {
    "id": 243,
    "center": "Media & Entertainment",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to an integrated journey of creating audio content, starting from developing the idea, building the story and writing the dialogue, through audio recording skills, editing and directing techniques, all the way to producing a final professional project."
  },
  {
    "id": 244,
    "center": "Media & Entertainment",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the world of Bahraini folk poetry through an interactive experience that combines literary appreciation and creative expression, to instill a love of national heritage, develop recitation skills, and strengthen the connection to cultural identity."
  },
  {
    "id": 245,
    "center": "Media & Entertainment",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of media presentation and effective communication in front of the audience and the camera, to enable them to build a confident media presence and develop the skills of interaction and influence in various situations and occasions."
  },
  {
    "id": 246,
    "center": "Media & Entertainment",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the basics of design in an interactive and fun way, with practical application using Canva. The program focuses on developing the visual sense, creative thinking, and arranging ideas visually through simple projects that simulate practical photography."
  },
  {
    "id": 247,
    "center": "Media & Entertainment",
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to guide participants towards creating purposeful and responsible content, by developing their skills in preparation, production, and initial publishing, in an integrated journey that creates a digital ambassador capable of making a positive impact."
  },
  {
    "id": 248,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to introduce participants to the world of special effects (SFX) makeup and cinematic storytelling, by training them in optical illusion techniques and creating realistic and imaginary features and effects, in a way that develops visual innovation and cinematic character building skills."
  },
  {
    "id": 250,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the foundations of theatrical décor design and its role in embodying the dramatic environment on stage, by exploring décor elements and types and the use of colors and lighting, in addition to enabling participants to read theatrical texts, design décor with accurate measurements, and implement three-dimensional models."
  },
  {
    "id": 254,
    "center": "Media & Entertainment",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to provide participants with basic skills in the art of food photography for commercial purposes, from controlling lighting and composition to formatting and visual storytelling, to produce professional, high-quality images for restaurants, brands, and social media platforms."
  },
  {
    "id": 255,
    "center": "Media & Entertainment",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enable participants to master the basics of creating digital content using a smartphone, and to develop their skills in photography, montage, and building a personal identity on social media platforms, in line with current standards for content creation."
  },
  {
    "id": 256,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 6:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of user experience design (UX Design) and its importance in developing digital products, through user-centered thinking methodology and training on modern design tools, which helps them understand professional opportunities and solve problems by creating effective solutions."
  },
  {
    "id": 262,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of producing visual content and making videos for social media platforms, through intensive practical training that covers the work stages from planning, photography, and lighting to montage and color processing, to produce digital content that simulates real work environments."
  },
  {
    "id": 264,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to train participants in the art of formulating intelligent questions and managing interviews, to enable them to explore deep human stories and create influential and professional media content that reflects contemporary facts and realities."
  },
  {
    "id": 266,
    "center": "Media & Entertainment",
    "title": "A story in 100 words.. How do you write a short and touching story?",
    "org": "Al-Ayyam newspaper",
    "age": "15 to 35 years",
    "ageMin": 15,
    "ageMax": 35,
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the art of writing short, condensed journalistic stories, by exploring how to transform daily situations and experiences into brief texts that tell a complete human story in a limited number of words, combining simplicity, depth of impact, and careful selection of details."
  },
  {
    "id": 267,
    "center": "Media & Entertainment",
    ...
    "time": "4:00 PM to 6:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to train participants to attract viewers’ attention in the first five seconds of visual content, by crafting strong intros and choosing effective visual shots, to enhance audience interaction and build a confident presence in front of the camera that is suitable for digital platforms."
  },
  {
    "id": 268,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enable participants to acquire the knowledge and practical skills necessary to use Adobe After Effects in producing and designing animation and animated graphic design works, through intensive applied training that contributes to developing their creative and artistic abilities."
  },
  {
    "id": 272,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to enable participants to produce media content that enhances national identity and reflects the values ​​of Bahraini society by exploring narrative methods and content creation through various media templates, which helps them express their ideas and issues in a creative and responsible manner that contributes to enhancing their presence in the national media scene."
  },
  {
    "id": 274,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the world of documentary films and their role in documenting stories and highlighting societal issues in a creative and influential manner, while highlighting the integration of artificial intelligence to develop visual content and production sessions, in addition to enabling participants to explore the stages of preparing a documentary film and how to employ modern technologies to produce works that combine visual narration and technology."
  },
  {
    "id": 279,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of creative writing and content creation, through an interactive and practical training experience that takes them from consuming content to producing influential texts in novels, articles, journalism, and digital narratives, in addition to enabling participants to undergo applied workshops and exercises that simulate professional editing and writing environments."
  },
  {
    "id": 281,
    "center": "Media & Entertainment",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the psychology of packaging and highlight the impact of packaging design in directing consumer behavior, through four main axes that include: cognitive perception, sensory impact, visual appeal, and emotional feeling, in addition to enabling participants to undergo practical applications for designing distinct and influential packaging in the market."
  },
  {
    "id": 282,
    "center": "Media & Entertainment",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to empower participants with the skills of photographing and producing commercial advertisements, by transforming their creative ideas into professional content that simulates the requirements of the labor market."
  },
  {
    "id": 283,
    "center": "Media & Entertainment",
  ...
  },
  {
    ...
    "timeCategory": "Morning",
    "description": "The program aims to teach participants the basics and skills of cooking through practical application in preparing various dishes and recipes, and learning about the steps to prepare food in a safe and orderly manner, while developing skills in using ingredients, presentation, and teamwork."
  },
  {
    "id": 288,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "9:00 AM to 11:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to enable participants to create custom watch designs by integrating art, design, and storytelling with artificial intelligence and digital manufacturing techniques, and concludes with a competition to choose the best design that expresses the participant’s identity."
  },
  {
    "id": 297,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "11:00 AM to 12:00 AM",
    "timeCategory": "Morning",
    "description": "The program aims to engage participants in an interactive and competitive experience to design and prepare their own sandwiches using various ingredients, which enhances creativity and teamwork and gives them the opportunity to present their ideas in a fun and stimulating atmosphere during which the creations are evaluated and the best ones are chosen."
  },
  {
    "id": 302,
    "center": "Arts & Culture",
    ...
    "time": "9:00 AM to 1:30 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop the artistic skills of participants through practical workshops that combine drawing, coloring, and handicrafts, where they learn the basics of drawing and coloring techniques using various materials and tools to develop their creative and expressive skills."
  },
  {
    "id": 303,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "9:00 AM to 1:30 AM",
    "timeCategory": "Morning",
    "description": "The program aims to develop participants' culinary skills through practical training in preparing various dishes, including healthy meals, snacks, desserts, and international dishes, while learning about the basics of meal planning, various cooking techniques, and food presentation methods."
  },
  {
    "id": 309,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:30 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to teach participants the arts of flower arranging through practical workshops covering the skills of combining colors and making bouquets to develop their craft skills and enable them to apply them practically."
  },
  {
    "id": 320,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "3:30 PM to 8:30 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to provide an interactive culinary arts workshop to celebrate the ancient Filipino culture and explore its identity through traditional dishes. The program combines theoretical and practical aspects to introduce participants to the distinctive flavors and ingredients of Filipino cuisine."
  },
  {
    "id": 328,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of sculpting molds using clay by learning shaping and manual sculpting techniques and transforming ideas into artistic models, which contributes to developing their artistic and creative skills through an interactive applied experience."
  },
  {
    "id": 334,
    "center": "Arts & Culture",
    "title": "Experimental studio: between color and space, a journey exploring color and movement",
    "org": "",
    "age": "15 to 35 years",
    "ageMin": 15,
    "ageMax": 35,
  ...
  },
  {
    ...
    "time": "3:30 PM to 8:30 PM",
    "timeCategory": "Afternoon",
    "description": "The program, in cooperation with the Alliance Francis Institute in the Kingdom of Bahrain and under the slogan “Create, Observe, Feel,” aims to introduce participants to French and Francophone culture and arts through interactive activities that include arts, cooking, fashion, and virtual reality technologies."
  },
  {
    "id": 337,
    "center": "Arts & Culture",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program, in cooperation with “Surface Studio,” aims to introduce participants to methods of documenting places and surfaces by exploring the textures and patterns surrounding them, and integrating them into a special diary using stamping and writing techniques and meditative activities."
  },
  {
    "id": 338,
    "center": "Arts & Culture",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basic techniques of illustration, by focusing on the skills of line drawing, shading, creating textures, and applying watercolor and ink layers through practical experiments to develop their expressive drawings."
  },
  {
    "id": 339,
    "center": "Arts & Culture",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to provide participants with a practical introduction to transforming initial ideas and drawings into 3D printed models, by exploring the technical stages of digital modeling and modern manufacturing tools."
  },
  {
    "id": 340,
    "center": "Arts & Culture",
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of drawing and decoration on Islamic ceramic tiles, by exploring traditional design principles and the harmony between geometric and floral shapes, to create artistic paintings inspired by antique tiles."
  },
  {
    "id": 341,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "4:00 PM to 6:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of preparing coffee and its different types through an interactive experience that combines learning and practical application, where participants go through the experience of preparing their own drinks using Nespresso products and devices, which enhances their skills and confidence in preparing coffee."
  },
  {
    "id": 343,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:30 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of fashion design through a creative experience that combines Bahraini identity and modern design, enabling them to create designs inspired by local culture and develop their skills in design thinking and expression."
  },
  {
    "id": 353,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "This program aims to train participants in the skills of culinary arts and meal preparation through an intensive practical experience accompanied by professional chefs. The program focuses on teaching participants the secrets behind creating healthy and popular meals, and testing their abilities in a final challenge, where the recipe that wins first place will receive a unique opportunity to be included on the “Callo Bahrain” menu and be transformed into a meal enjoyed by thousands."
  },
  {
    "id": 355,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:00 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of preparing healthy, balanced salads and selecting their ingredients, and to apply this in practice by designing special recipes and participating in daily competitions based on evaluating the taste, visual presentation, and nutritional value of the dish."
  },
  {
    "id": 361,
    "center": "Arts & Culture",
  ...
  },
  {
    ...
    "time": "4:00 PM to 8:30 PM",
    "timeCategory": "Afternoon",
    "description": "The program aims to introduce participants to the basics of shaving and appearance care, by covering hair cutting and styling techniques, beard care, and learning about the tools used in professional styling through direct practical applications."
  },
  {
    "id": 367,
    "center": "Arts & Culture",
...
const parseDays = (daysStr, datesStr) => {
  ...
  if (str.includes('every day') || str.includes('all week') || str.includes('all days')) return ['sun', 'mon', 'tue', 'wed', 'thu', 'fri', 'sat']; 
  const days = [];
...
const parseTime = (timeStr, category) => {
  ...
  if (!parts[0].includes('am') && !parts[0].includes('pm')) {
     if ((category === 'Evening' || category === 'Afternoon') && start < 12) start += 12;
  }
  if (!parts[1].includes('am') && !parts[1].includes('pm')) {
     if ((category === 'Evening' || category === 'Afternoon') && end < 12) end += 12;
  }
  ...
  if (start === 0 && (category === 'Morning' || category === 'Afternoon')) { start += 12; }
  if (end === 1 && (category === 'Morning' || category === 'Afternoon') && start >= 12) { end += 12; }
...
export default function WorkshopExplorer() {
  ...
  const filteredWorkshops = useMemo(() => {
    let results = workshops.filter(ws => {
      const matchesTime = selectedTime === "All" || ws.timeCategory === selectedTime;

      let matchesAge = true;
      if (selectedAge !== "All") {
        if (selectedAge === "7-11") matchesAge = ws.ageMin <= 11 && ws.ageMax >= 7;
        else if (selectedAge === "12-14") matchesAge = ws.ageMin <= 14 && ws.ageMax >= 12;
        else if (selectedAge === "15-18") matchesAge = ws.ageMin <= 18 && ws.ageMax >= 15;
    ...
    if (interestQuery.trim() !== "") {
      const queryWords = interestQuery.toLowerCase().split(/\s+/).filter(w => w.length > 2);
      
      results = results.map(ws => {
        let score = 0;
        const textToSearch = `${ws.title} ${ws.description} ${ws.org}`.toLowerCase();
  ...
  const calendarData = useMemo(() => {
    ...
    savedWorkshops.forEach(ws => {
      ...
      const isConflict = conflicts.some(c => c.w1.id === ws.id || c.w2.id === ws.id);
    ...
    <div className="min-h-screen bg-[#f8fcf9] text-slate-800 font-sans p-4 md:p-8">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <header className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-[#e2ece5]">
          <div>
            <h1 className="text-3xl font-bold text-[#0c2340]">Youth City Explorer</h1>
            <p className="text-slate-500 mt-1">Filter scraped workshop data and build your schedule</p>
          </div>
          <div className="flex flex-wrap gap-2">
            <button 
              onClick={() => setView(view === "explore" ? "schedule" : "explore")}
            ...
            >
              {view === "explore" ? <CalendarDays size={18} /> : <ArrowLeft size={18} />}
              {view === "explore" ? `My Schedule (${savedIds.length})` : "Back to Explorer"}
            </button>
            <button 
        ...
        {showDataPaste && (
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-[#e2ece5] animate-in fade-in slide-in-from-top-4">
            <h3 className="font-bold text-[#0c2340] mb-2">Paste JSON Data from Scraper</h3>
            <textarea 
            ...
            <div className="flex justify-end gap-2">
              <button onClick={() => setShowDataPaste(false)} className="px-4 py-2 text-slate-500 hover:bg-slate-100 rounded-xl font-medium">Cancel</button>
              <button onClick={handleImportData} className="px-4 py-2 bg-[#1964d6] text-white rounded-xl font-medium hover:bg-blue-700">Load Data</button>
            </div>
          </div>
        )}
        ...
        {view === "explore" ? (
          <div className="flex flex-col lg:flex-row gap-6">
            <aside className="w-full lg:w-64 flex-shrink-0 space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-slate-700 mb-2">Smart Matcher</label>
            ...
            <main className="flex-1">
              <div className="mb-4 flex items-center justify-between">
                <h2 className="text-xl font-bold text-[#0c2340]">Available Workshops</h2>
              ...
              {filteredWorkshops.length === 0 ? (
                <div className="bg-white p-12 rounded-2xl border border-dashed border-slate-300 text-center text-slate-500">
                  ...
                  <button 
                    onClick={() => { setInterestQuery(""); setSelectedAge("All"); setSelectedTime("All"); }}
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                  {filteredWorkshops.map(ws => (
                    <div key={ws.id} className="bg-white p-5 rounded-2xl shadow-sm border border-[#e2ece5] hover:shadow-md hover:border-[#b4d2c1] transition-all flex flex-col h-full relative overflow-hidden">
                      ...
                      <div className="flex-1 mt-2">
                        <div className="flex justify-between items-start mb-2">
                          <h3 className="font-bold text-lg text-[#0c2340] leading-tight">{ws.title}</h3>
                        </div>
                      ...
                      <div className="space-y-3 pt-4 border-t border-slate-100">
                         ...
                         <div className="flex items-center justify-between text-sm text-slate-600 bg-slate-50 p-2 rounded-lg">
                            <div className="flex items-center gap-1.5">
                              ...
                              <span className="truncate max-w-[120px]">{ws.days}</span>
                            </div>
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-[#0c2340]">My Saved Workshops</h2>
              <p className="text-slate-500">Review your selections and check for time conflicts.</p>
            </div>
            ...
            {conflicts.length > 0 && (
              <div className="mb-8 p-5 bg-red-50 border-l-4 border-red-500 rounded-r-xl shadow-sm">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-red-800 text-lg">Schedule Conflicts Detected</h3>
                    <p className="text-red-600 text-sm mb-3">The following workshops happen on the same days and have overlapping times:</p>
                    <ul className="space-y-2">
                      {conflicts.map((c, idx) => (
                        <li key={idx} className="bg-white/60 px-3 py-2 rounded-lg text-red-800 text-sm font-medium border border-red-100">
                          <span className="font-bold underline">{c.w1.title}</span> clashes with <span className="font-bold underline">{c.w2.title}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
            ...
            {savedWorkshops.length === 0 ? (
              <div className="bg-white p-12 rounded-2xl border border-dashed border-slate-300 text-center text-slate-500 flex flex-col items-center">
                ...
                <p className="mb-6">Go back to the explorer to add some workshops.</p>
                <button 
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-[#e2ece5] overflow-hidden">
                  <div className="p-4 border-b border-slate-100 bg-slate-50">
                    <h3 className="font-bold text-[#0c2340]">Weekly Calendar View</h3>
                  </div>
                  <div className="flex overflow-x-auto">
                    <div className="flex-none w-16 flex flex-col border-r border-slate-100 bg-slate-50">
                      ...
                      {hoursOfDay.map(h => (
                        <div key={h} className="h-14 border-b border-slate-100 text-[10px] text-right pr-2 py-1 text-slate-400 font-medium">
                          {h > 12 ? `${h-12} PM` : h === 12 ? '12 PM' : `${h} AM`}
                        </div>
                      ))}
                    </div>
                    {calendarData.map(day => (
                      <div key={day.key} className="flex-1 min-w-[100px] border-r border-slate-100 relative">
                        ...
                        <div className="relative" style={{ height: `${hoursOfDay.length * 56}px` }}>
                          {hoursOfDay.map(h => (
                            <div key={h} className="h-14 border-b border-slate-50 w-full absolute" style={{ top: `${(h - 8) * 56}px`}}></div>
                          ))}
                          {day.events.map((event, idx) => {
                            const top = (event.startTime - 8) * 56;
                            const height = (event.endTime - event.startTime) * 56;
                            return (
                              <div key={`${event.id}-${idx}`} className="absolute w-full px-1" style={{ top: `${top}px`, height: `${height}px`, zIndex: event.isConflict ? 10 : 5}}>
                                <div className={`rounded-md p-1.5 text-xs h-full overflow-hidden leading-tight border ${event.isConflict ? 'bg-red-100 border-red-400 text-red-800 shadow-sm' : 'bg-blue-100 border-blue-300 text-blue-800 hover:bg-blue-200'}`}>
                ...
                <div>
                  <h3 className="font-bold text-[#0c2340] mb-4">Workshop Details</h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {savedWorkshops.map(ws => (
                      <div key={ws.id} className="bg-white p-5 rounded-2xl shadow-sm border border-[#e2ece5] flex flex-col h-full relative">
                        <div className="flex-1">
                          <h3 className="font-bold text-lg text-[#0c2340] leading-tight mb-1">{ws.title}</h3>
                          <p className="text-sm text-slate-500 mb-4">{ws.org}</p>
